...
import { saveUserCredentials, setCurrentUser } from '../utils/userData';
...
const Register = ({ onSectionChange, onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const success = saveUserCredentials(formData.email, formData.password);
    ...
    <div className="min-h-screen bg-[#F3F4F6] flex items-center justify-center p-6">
      <div className="max-w-md w-full">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-[#1E293B] mb-2">Create Account</h1>
          <p className="text-gray-600">Join EduHire and start your journey</p>
        </motion.div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#2C5F34] focus:border-transparent transition-all duration-200 ${
            ...
            <div>
              <div className="flex items-start space-x-3">
                <input
                  ...
                  className="mt-1 h-4 w-4 text-[#2C5F34] focus:ring-[#2C5F34] border-gray-300 rounded"
                />
                <label htmlFor="agree-terms" className="text-sm text-gray-700">
                  I agree to the{' '}
                  <button
                    type="button"
                    className="text-[#2C5F34] hover:text-[#FFD700] underline"
                  >
                    Terms of Service
                  </button>{' '}
                  and{' '}
